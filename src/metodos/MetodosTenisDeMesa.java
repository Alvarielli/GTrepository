...
/**
 * Es igual que el Tenis a 5 sets pero con los JF y JC como PF y PC (en la clasificación)
 * @author Alvarielli
 */
public class MetodosTenisDeMesa extends Metodos {
    ...
    private final int CODIGO_ANCHO = 217;
    private final int CODIGO_ALTO = 22;
    private final int CODIGO_ANCHO_CLASF = 232;
    private final int CODIGO_ALTO_CLASF = 23;
    
    //En el constructor de clase le pasamos todo lo requerido para esta clase desde Principal
    public MetodosTenisDeMesa(DefaultTableModel modelo, DefaultTableModel clasificacion, int jornada, JTable TableJornada, JTable TableClasificacion, JLabel LabelEquipoDescansa,
    ...
    public void informeJornada(String rutaPDF, String nombreArchivo, boolean aplazados, ArrayList<Partido> partidosAplazados){
       ...
       if(aplazados){
        ...
        try {
            ...
            Logger.getLogger(MetodosTenisDeMesa.class.getName()).log(Level.SEVERE, null, ex);
        }
