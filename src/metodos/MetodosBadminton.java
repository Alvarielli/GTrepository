...
/**
 * Es igual que el Tenis a 3 sets pero con los JF y JC como PF y PC (en la clasificación)
 * @author Alvarielli
 */
public class MetodosBadminton extends Metodos{
    ...
    private RenderTenis3S render;//Válidos también para Badmintón
    ...
    private final int CODIGO_ANCHO = 15;
    private final int CODIGO_ALTO = 2;
    private final int CODIGO_ANCHO_CLASF = 26;
    private final int CODIGO_ALTO_CLASF = 3;
    
    
    //En el constructor de clase le pasamos todo lo requerido para esta clase desde Principal
    public MetodosBadminton(DefaultTableModel modelo, DefaultTableModel clasificacion, int jornada, JTable TableJornada, JTable TableClasificacion, JLabel LabelEquipoDescansa,
    ...
    @Override
     public void cargarClasificacion(){
        //Textos para las columnas
        String[] columnasLocal = {"POS","COMPETIDOR", "PJ", "PG", "PP", "SF", "SC", "PF", "PC"};
    ...
    public void informeJornada(String rutaPDF, String nombreArchivo, boolean aplazados, ArrayList<Partido> partidosAplazados){
       ...
       String descansa = "";//Obtenemos el nombre del equipo que descansa        
        ...
        try {
            ...
            Logger.getLogger(MetodosBadminton.class.getName()).log(Level.SEVERE, null, ex);
        }
