...
public class MetodosEliminatoriaVoleibol extends Metodos{
    ...
    private final int CODIGO_ANCHO = 347;
    private final int CODIGO_ALTO = 31;
    ...
    public MetodosEliminatoriaVoleibol(DefaultTableModel modelo, int jornada, JTable TableJornada,JLabel LabelJornada, JLabel LabelTotalJornadas, 
    ...
    public void informeJornada(String rutaPDF, String nombreArchivo, boolean aplazados, ArrayList<Partido> partidosAplazados){
       ...
       if(aplazados){
        ...
        try {
            ...
            Logger.getLogger(MetodosEliminatoriaVoleibol.class.getName()).log(Level.SEVERE, null, ex);
        }
