...
import renders.RenderFutbolClasf;
...
/**
 * Válido también para fútbol sala, hockey patines
 * @author Alvarielli
 */
public class MetodosFutbol extends Metodos{
    ...
    private int alturaColumna = 50;//Indica la altura de la columna
    private int alturaClasfColumna = 25;//Indica la altura de las filas de la columna en la tabla de clasificación
    private RenderFutbol render;
    private RenderFutbolClasf renderClasf;
    private int[] num = {8, 20, 24, 8, 14, 12, 14};//valores predeterminados (ahora se cargan del archivo.txt)
    private int[] numc = {2, 12, 9, 9, 25, 9, 9, 9, 16};
    ...
    private final int CODIGO_ANCHO = 104;
    private final int CODIGO_ALTO = 10;
    private final int CODIGO_ANCHO_CLASF = 111;
    private final int CODIGO_ALTO_CLASF = 11;
    
    
         
    //En el constructor de clase le pasamos todo lo requerido para esta clase desde Principal
    public MetodosFutbol(DefaultTableModel modelo, DefaultTableModel clasificacion, int jornada, JTable TableJornada, JTable TableClasificacion, JLabel LabelEquipoDescansa,
    ...
    public void cargarTabla(int jornada){
        ...
        //Definimos los anchos de las columnas y los asignamos como tamaño preferente
         int[] anchos = {(anchoTabla*getNum()[0])/100, (anchoTabla*getNum()[1])/100, (anchoTabla*getNum()[2])/100, (anchoTabla*getNum()[3])/100, (anchoTabla*getNum()[4])/100, (anchoTabla*getNum()[5])/100, (anchoTabla*getNum()[6])/100};
    ...
    @Override
     public void cargarClasificacion(){
        //Textos para las columnas
        String[] columnasLocal = {"POS","COMPETIDOR", "PJ", "PG", "PE", "PP", "GF", "GC", "PTOS"};
        ...
        int[] anchos = {(anchoTabla*getNumc()[0])/100, (anchoTabla*getNumc()[1])/100, (anchoTabla*getNumc()[2])/100, (anchoTabla*getNumc()[3])/100, (anchoTabla*getNumc()[4])/100, (anchoTabla*getNumc()[5])/100, (anchoTabla*getNumc()[6])/100, (anchoTabla*getNumc()[7])/100, (anchoTabla*getNumc()[8])/100};
        ...
        renderClasf = new RenderFutbolClasf();
    ...
    @Override
     public void ordenarClasificacion(){
        ...
        Collections.sort(getCastEquipoLista().getEquipos(), new Comparator<EquipoFutbol>() {
            ...
            public int compare(EquipoFutbol e1, EquipoFutbol e2) {
                    ...
                    return new Integer(e2.getGf()).compareTo(e1.getGf());//compareTo(new Integer(e1.getPf()));
            }                                        
        });
     ...
     public void guardarXML(String ruta, String nombreArchivo){
        ...
        for (int i = 0; i < getNum_jornadas(); i++) {          
        ...
        // display nice nice
        xmlOutput.setFormat(Format.getPrettyFormat());//.setEncoding("windows1252")
    ...
    public void informeJornada(String rutaPDF, String nombreArchivo, boolean aplazados, ArrayList<Partido> partidosAplazados){
        ...
        if(aplazados){
         ...
         parametros.put("nombreTorneo", getNombreTorneo());
         ...
         try {
             ...
             if(nombreArchivo.equalsIgnoreCase("")){
                 exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new java.io.File(rutaPDF + "/" + getNombreTorneo() + "_JOR" + jornada + ".pdf")); 
             }else{
    ...
    public void informeResultados(String rutaPDF, String nombreArchivo, boolean aplazados, ArrayList<Partido> partidosAplazados){
       ...
       DataSourceFutbolResultados datasource = new DataSourceFutbolResultados();
        ...
        try {
            ...
            //En función del nombre del archivo lo nombramos de una forma o de otra
            if(nombreArchivo.equalsIgnoreCase("")){
                exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new java.io.File(rutaPDF + "/" + getNombreTorneo() + "_RES" + jornada + ".pdf")); 
            }else{
                exporter.setParameter(JRExporterParameter.OUTPUT_FILE, new java.io.File(rutaPDF + "/" + nombreArchivo));
            }
            exporter.exportReport();
    ...
    public void informeClasificacion(String rutaPDF, String nombreArchivo){
       ...
       ArrayList<EquipoFutbol> equipos = castEquipoLista.getEquipos();
        ...
        File archivoInforme = new File("src/informes/futbolClasificacion.jasper");
        JasperReport reporte;
        //Creamos un HashMap para poder utilizar los parámetros en el informe
        HashMap<String, Object> parametros = new HashMap<>();
        parametros.put("nombreTorneo", getNombreTorneo());
