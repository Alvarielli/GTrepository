...
public class MetodosBasket extends Metodos{
    ...
    private RenderFutbol render;//El Basket puede usar el Render del Fútbol para el calendario y el del Tenis para la Clasificación
    ...
    private final int CODIGO_ANCHO = 51;
    private final int CODIGO_ALTO = 6;
    private final int CODIGO_ANCHO_CLASF = 58;
    private final int CODIGO_ALTO_CLASF = 7;
    
    //En el constructor de clase le pasamos todo lo requerido para esta clase desde Principal
    public MetodosBasket(DefaultTableModel modelo, DefaultTableModel clasificacion, int jornada, JTable TableJornada, JTable TableClasificacion, JLabel LabelEquipoDescansa,
    ...
    @Override
     public void cargarClasificacion(){
        //Textos para las columnas
        String[] columnasLocal = {"POS","COMPETIDOR", "PJ", "PG", "PP", "PF", "PC", "DIF"};
     ...
     public void asignarDatos(EquipoBasket equipo, String local, int PtosL, int PtosV, String visitante){
         ...
         if(PtosL < 0 || PtosV < 0){
            ...
            if(equipo.getNombre().equalsIgnoreCase(local)){
               ...
               equipo.setDif(equipo.getDif() + dif);
    ...
    @Override
     ...
     /**
      * CRITERIOS DE DESEMPATE EXTRA
      * Por si se requiere en el futuro, existe para equipos empatados a todo, la suma de cocientes que consiste en sumar todas las divisiones
      * de los partidos del campeonato, 92/77 + 87/92... para que al final el que mayor promedio sume se coloque encima del rival
      * Lo curioso de este sistema es que premia a los equipos que menos puntos anotan es decir es mejor ganar 2/1 que 90/89
      */
    ...
    public void informeJornada(String rutaPDF, String nombreArchivo, boolean aplazados, ArrayList<Partido> partidosAplazados){
       ...
       if(aplazados){
        ...
        try {
            ...
            Logger.getLogger(MetodosBasket.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void informeClasificacion(String rutaPDF, String nombreArchivo){
       ...
       ArrayList<EquipoBasket> equipos = castEquipoLista.getEquipos();
        DataSourceBasketClasificacion datasource = new DataSourceBasketClasificacion();  
        //Añadimos los partidos de la jornada al datasource
        ...
        File archivoInforme = new File("src/informes/basketClasificacion.jasper");
        JasperReport reporte;
        //Creamos un HashMap para poder utilizar los parámetros en el informe
        HashMap<String, Object> parametros = new HashMap<>();
        parametros.put("nombreTorneo", nombreTorneo);
