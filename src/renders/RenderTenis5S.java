 ...
 * @author Alvarielli
 */
public class RenderTenis5S extends DefaultTableCellRenderer{
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        if (value instanceof String){
            if(column == 2 || column == 13){
            ...
            }else if(column == 3 || column == 4 || column == 7 || column == 8 || column == 11 || column == 12){
                ...
                this.setText((String)value);
            }else if(column == 5 || column == 6 || column == 9 || column == 10){
                //Los resultados totales irán en azul y negrita
                this.setOpaque(true); 
                this.setHorizontalAlignment(SwingConstants.CENTER);
                this.setFont(new Font("Tahoma", Font.BOLD, 14));
