...
/**
 * Igual que el fútbol pero dándole un estilo a la columna de la prórroga (que el fútbol no tiene)
 * @author Alvarielli
 */
public class RenderHockeyHielo extends DefaultTableCellRenderer{
