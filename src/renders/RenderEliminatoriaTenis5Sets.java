 ...
 * @author Alvarielli
 */
public class RenderEliminatoriaTenis5Sets extends DefaultTableCellRenderer{
    @Override
     public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        if (value instanceof String){
            if(column == 2 || column == 13){
            ...
            }else if(column == 3 || column == 4 || column == 7 || column == 8 || column == 11 || column == 12 || column == 15){//Añadimos el estilo a la columna del ganador
                ...
                this.setText((String)value);
            }else if(column == 5 || column == 6 ||  column == 9 || column == 10){//Añadimos el estilo a la columna del ganador
                //Los resultados totales irán en azul y negrita
                this.setOpaque(true); 
                this.setHorizontalAlignment(SwingConstants.CENTER);
                this.setFont(new Font("Tahoma", Font.BOLD, 14));
        ...
        if(row % 2 == 0){
            ...
            if (value instanceof String){
                if(column == 3 || column == 4 || column == 7 || column == 8 || column == 11 || column == 12){
        ...
        //Asignamos el ToolTipText en función de la columna
        if(column == 15){
            this.setToolTipText("Selecciona el Ganador de la Eliminatoria");
        }else{
            this.setToolTipText("Alt + click para copiar y pegar texto");
        }
