 ...
 * @author Alvarielli
 */
public class RenderEliminatoriaTenis3Sets extends DefaultTableCellRenderer{
    @Override
     public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        if (value instanceof String){
            if(column == 2 || column == 9){
            ...
            }else if(column == 3 || column == 4 || column == 7 || column == 8 || column == 11){//Añadimos el estilo a la columna del ganador
                ...
                this.setText((String)value);
            }else if(column == 5 || column == 6){//Añadimos el estilo a la columna del ganador
                //Los resultados totales irán en azul y negrita
                this.setOpaque(true); 
                this.setHorizontalAlignment(SwingConstants.CENTER);
                this.setFont(new Font("Tahoma", Font.BOLD, 14));
