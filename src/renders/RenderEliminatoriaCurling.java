 ...
 * @author Alvarielli
 */
public class RenderEliminatoriaCurling extends DefaultTableCellRenderer{
     ...
     public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column){
        ...
        if (value instanceof String){
            if(column == 2 || column == 29){
            ...
            }else if(column == 15 || column == 28 || column == 31){//Añadimos el Local o Visitante
                ...
                this.setText((String)value);
            }else if(column >= 3 && column < 28 && column != 15){
                if((!value.equals("0"))){
