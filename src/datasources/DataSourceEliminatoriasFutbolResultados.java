 ...
 * @author Alvarielli
 */
public class DataSourceEliminatoriasFutbolResultados implements JRDataSource{

    private List<PartidoEliminatoria> partidosInforme = new ArrayList<>();
    ...
    public void addPartido(PartidoEliminatoria partido)
    {
