 ...
 * @author Alvarielli
 */
public class DataSourceTenis3SetsResultados implements JRDataSource{

    private List<PartidoTenis3Sets> partidosInforme = new ArrayList<>();
    ...
    public void addPartido(PartidoTenis3Sets partido)
    {
