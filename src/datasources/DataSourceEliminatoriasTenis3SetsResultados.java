 ...
 * @author Alvarielli
 */
public class DataSourceEliminatoriasTenis3SetsResultados implements JRDataSource{

    private List<PartidoEliminatoriaTenis3Sets> partidosInforme = new ArrayList<>();
    ...
    public void addPartido(PartidoEliminatoriaTenis3Sets partido)
    {
