...
/**
 * También sirve para Curling y Béisbol (ignorando el campo dif)
 * @author Alvarielli
 */

public class DataSourceBasketClasificacion implements JRDataSource{

    private List<EquipoBasket> equiposInforme = new ArrayList<>();
    ...
    public Object getFieldValue(JRField jrf) throws JRException {
        ...
        }else if("dif".equals(jrf.getName())) {//sólo para basket 
            valor = equiposInforme.get(indice).getDif();
        }
        return valor; 
    } 
}
