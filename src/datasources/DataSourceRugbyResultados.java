 ...
 * @author Alvarielli
 */
public class DataSourceRugbyResultados implements JRDataSource{

    private List<PartidoRugby> partidosInforme = new ArrayList<>();
    ...
    public void addPartido(PartidoRugby partido)
    {
    ...
    public Object getFieldValue(JRField jrf) throws JRException {
        ...
        }else if("triesL".equals(jrf.getName())) { 
            valor = valueOf(partidosInforme.get(indice).getTriesL());
            //si nos pasan un partido vacío convertimos el -1 en un hueco
            if(valor.toString().equalsIgnoreCase("-1")){
                valor = "";
            }
        }else if("triesV".equals(jrf.getName())) { 
            //si nos pasan un partido vacío convertimos el -1 en un hueco
            valor = valueOf(partidosInforme.get(indice).getTriesV());
            if(valor.toString().equalsIgnoreCase("-1")){
                valor = "";
            }
        }
