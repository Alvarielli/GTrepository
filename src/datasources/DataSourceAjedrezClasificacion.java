...
public class DataSourceAjedrezClasificacion implements JRDataSource{

    private List<EquipoAjedrez> equiposInforme = new ArrayList<>();
    ...
    public void addEquipo(EquipoAjedrez equipo)
    {
    ...
    public Object getFieldValue(JRField jrf) throws JRException {
        ...
        }else if("sb".equals(jrf.getName())) { 
            valor = equiposInforme.get(indice).getSb();
        }
        return valor; 
    } 
}
