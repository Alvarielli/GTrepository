...
public class DataSourceBeisbolResultados implements JRDataSource{

    private List<PartidoBeisbol> partidosInforme = new ArrayList<>();
    ...
    public void addPartido(PartidoBeisbol partido)
    {
