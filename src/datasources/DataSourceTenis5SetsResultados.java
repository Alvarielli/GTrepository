 ...
 * @author Alvarielli
 */
public class DataSourceTenis5SetsResultados implements JRDataSource{

    private List<PartidoTenis5Sets> partidosInforme = new ArrayList<>();
    ...
    public void addPartido(PartidoTenis5Sets partido)
    {
