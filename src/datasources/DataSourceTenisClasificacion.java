...
public class DataSourceTenisClasificacion implements JRDataSource{

    private List<EquipoTenis> equiposInforme = new ArrayList<>();
    ...
    public void addEquipo(EquipoTenis equipo)
    {
    ...
    public Object getFieldValue(JRField jrf) throws JRException {
        ...
        }else if("sf".equals(jrf.getName())) { 
            valor = equiposInforme.get(indice).getSf();
        }else if("sc".equals(jrf.getName())) { 
            valor = equiposInforme.get(indice).getSc();
        }else if("pf".equals(jrf.getName())) { 
            valor = equiposInforme.get(indice).getJf();
        }else if("pc".equals(jrf.getName())) { 
            valor = equiposInforme.get(indice).getJc();
        }
        return valor; 
    } 
}
