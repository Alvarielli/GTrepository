 ...
 * @author Alvarielli
 */
public class DataSourceAjedrezResultados implements JRDataSource{

    private List<PartidoAjedrez> partidosInforme = new ArrayList<>();
    ...
    public void addPartido(PartidoAjedrez partido)
    {
