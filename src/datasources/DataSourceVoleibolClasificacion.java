...
public class DataSourceVoleibolClasificacion implements JRDataSource{

    private List<EquipoVoleibol> equiposInforme = new ArrayList<>();
    ...
    public void addEquipo(EquipoVoleibol equipo)
    {
