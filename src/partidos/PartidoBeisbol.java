 ...
 * @author Alvarielli
 */
public class PartidoBeisbol extends Partido{
    ...
    public PartidoBeisbol(String local, String visitante){
    ...
    public PartidoBeisbol(String fecha, String hora, String local, int RL1, int RL2, int RL3, int RL4, int RL5, int RL6, int RL7, int RL8, int RL9,
             int RL10, int RL11, int RL12, int golesL, int RV1, int RV2, int RV3, int RV4, int RV5, int RV6, int RV7, int RV8, int RV9,
             int RV10, int RV11, int RV12, int golesV, String visitante, String pista){
