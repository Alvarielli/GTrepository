 ...
 * @author Alvarielli
 */
public class PartidoEliminatoriaTenis3Sets extends PartidoEliminatoria{
    ...
    public PartidoEliminatoriaTenis3Sets(String local, String visitante){
    ...
    public PartidoEliminatoriaTenis3Sets(String fecha, String hora, String local, int set1L, int set1V, int set2L, int set2V, int set3L, int set3V, 
