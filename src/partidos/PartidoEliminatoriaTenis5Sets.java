 ...
 * @author Alvarielli
 */
public class PartidoEliminatoriaTenis5Sets extends PartidoEliminatoria{
    ...
    public PartidoEliminatoriaTenis5Sets(String local, String visitante){
    ...
    public PartidoEliminatoriaTenis5Sets(String fecha, String hora, String local, int set1L, int set1V, int set2L, int set2V, int set3L, int set3V, int set4L, int set4V, int set5L, int set5V,
            String visitante, String pista, String ganador, String desempate){
        super(local, visitante);
        this.fecha = fecha;
        this.hora = hora;
        this.pista = pista;
