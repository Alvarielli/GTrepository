 ...
 * @author Alvarielli
 */
public class ModTablasDialog extends javax.swing.JDialog {
    ...
    public ModTablasDialog(java.awt.Frame parent, boolean modal, int tipo_torneo, int[]num, int altura, String[] columnas) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        ButtonCancelar.setText(bundle.getString("ModTablasDialog.ButtonCancelar.text")); // NOI18N
        ...
        ButtonAceptar.setText(bundle.getString("ModTablasDialog.ButtonAceptar.text")); // NOI18N
        ButtonAceptar.setToolTipText(bundle.getString("ModTablasDialog.ButtonAceptar.toolTipText")); // NOI18N
    ...
    private void ButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAceptarActionPerformed
        int[] auxArray = new int[num.length];//Completamente necesario inicializarlos
        int auxAltura;
        ...
        if(ancho_control == 100){
            ...
            for (int j = 0; j < listaSpinners.size() - 1; j++) {//Menos el spinner de la altura y otro porque es un índice
                auxArray[j] = validarEnterosMTD(listaSpinners.get(j).getValue().toString().trim());
            }
            auxAltura = (int) listaSpinners.get(listaSpinners.size() - 1).getValue();
            //Asignamos los datos de la tabla al archivo
            deporte.setDatosTabla(auxArray, auxAltura);
            //Cerramos el diálogo y volvemos a la pantalla original
            this.closeDialog(null);
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModTablasDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModTablasDialog dialog = new ModTablasDialog(new javax.swing.JFrame(), true, tipo_torneo, num, altura, columnas);
